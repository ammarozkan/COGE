...
{
	return object->object.position - object->object.getFront()*10.0f;
}
...
{
	GAME_TPSController *PC = ((GAME_TPSController*)data);
	object->object.rotateRelative(glm::vec3(0.0f,1.0f,0.0f),glm::radians(+30.0f)*deltaTime);
}
